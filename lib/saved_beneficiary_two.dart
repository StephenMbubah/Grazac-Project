...
class SavedBeneficiaryTwo extends StatelessWidget {
  const SavedBeneficiaryTwo({Key? key}) : super(key: key);
              ...
              child: Column(
                ...
                children: [
                  ...
                  DottedBorder(
                    ...
                    child: Container(
                      decoration: BoxDecoration(borderRadius: BorderRadius.circular(15),color: const Color(0xFFFFE7EF),),
                      height:95 ,
                      width: double.infinity,
                  ...
                  const Text("Transaction Fee", style: TextStyle(fontSize: 16, fontWeight: FontWeight.w600,color: Color(0xFF00493C)),),
                  Container(
                    padding: const EdgeInsets.symmetric(horizontal: 16,vertical: 13),
                    height: 50,
                    width: double.infinity,
                  ...
                  Container(
                    ...
                    child: Padding(
                      ...
                      child: Row(
                        mainAxisAlignment: MainAxisAlignment.spaceBetween,
                        children: const [
                          Text("Individual",style: TextStyle(fontSize: 16, fontWeight: FontWeight.w500, color: Color(0xFFC5C4C4)),),
