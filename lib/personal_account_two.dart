...
class PersonalAccountTwo extends StatelessWidget {
  const PersonalAccountTwo({Key? key}) : super(key: key);
              ...
              Padding(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    const Align(
                        alignment: Alignment.centerLeft,
                        child: Text("Transaction Narration",style: TextStyle(fontSize: 16,fontWeight: FontWeight.w600),)),
                    Container(
                      padding: const EdgeInsets.symmetric(horizontal: 16,vertical: 13),
                      height: 90,
                      width: double.infinity,
