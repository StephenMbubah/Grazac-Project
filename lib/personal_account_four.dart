...
import 'package:grazac_first_project/personal_account_three.dart';

class PersonalAccountFour extends StatelessWidget {
  const PersonalAccountFour({Key? key}) : super(key: key);
          ...
          children: [
            Container(
              ...
              child: GestureDetector(
                  onTap: (){
                    Navigator.push(context, MaterialPageRoute(builder: (context) =>  const PersonalAccountThree()));
                  },
              ...
              child: Row(
                children: [
                  ...
                  Container(
                    ...
                    width: 46,
                    decoration: BoxDecoration(borderRadius: BorderRadius.circular(8),color: const Color(0xFFFAFAFA)),
                    child: TextFormField(keyboardType: TextInputType.number,maxLength: 1.hashCode,decoration:InputDecoration(fillColor: Colors.green),),
                  ),
                  const SizedBox(
                    width: 8,
                  ),
